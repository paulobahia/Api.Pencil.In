...
import { UpdateOperationHourHandler } from './commands/handlers/update-operationHour.handler';
...
const application = [FindOperationHourHandler, CreateOperationHourHandler, UpdateOperationHourHandler];
