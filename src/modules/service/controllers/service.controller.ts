...
import { FindServiceByIdResponseDto } from '../dtos/find-service-by-id-response.dto';
...
export class ServiceController {
  ...
  ): Promise<FindServiceResponseDto> {
  ...
  async updateService(
    @Param() param: UpdateServiceRequestParam,
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: ResponseDescription.OK,
    type: FindServiceByIdResponseDto,
  })
  @ApiBadRequestResponse({ description: ResponseDescription.BAD_REQUEST })
  @ApiUnauthorizedResponse({ description: ResponseDescription.UNAUTHORIZED })
  @ApiNotFoundResponse({ description: ResponseDescription.NOT_FOUND })
  ...
  async getServiceById(
    @Param() param: FindServiceByIdRequestParam,
    @EstablishmentId() establishmentId: string,
  ): Promise<FindServiceByIdResponseDto> {
    const id = param.id;
  ...
  @ApiUnauthorizedResponse({ description: ResponseDescription.UNAUTHORIZED })
  async deleteService(
    @Param() param: DeleteServiceRequestDto,
    @EstablishmentId() establishmentId: string,
  ): Promise<void> {
    const id = param.id;
