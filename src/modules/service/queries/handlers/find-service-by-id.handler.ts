...
export class FindServiceByIdHandler implements IQueryHandler<FindServiceByIdQuery, FindServiceByIdResult> {
  @Inject(InjectionToken.ESTABLISHMENT_REPOSITORY)
  private readonly establishmentRepository: EstablishmentRepository
  @Inject(InjectionToken.SERVICE_REPOSITORY)
  private readonly serviceRepository: ServiceRepository

  async execute({ id, establishmentId }: FindServiceByIdQuery): Promise<FindServiceByIdResult> {
