...
export class FindEmployeeHandler implements IQueryHandler<FindEmployeeQuery, FindEmployeeResult> {
  @Inject(InjectionToken.ESTABLISHMENT_REPOSITORY)
  private readonly establishmentRepository: EstablishmentRepository
  @Inject(InjectionToken.EMPLOYEE_REPOSITORY)
  private readonly employeeRepository: EmployeeRepository

  async execute({ establishmentId }: FindEmployeeQuery): Promise<FindEmployeeResult> {
