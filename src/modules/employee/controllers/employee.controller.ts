...
export class EmployeeController {
  ...
  async getEmployee(
    @EstablishmentId() establishmentId: string,
  ): Promise<FindEmployeeResponseDto> {
  ...
  async updateEmployee(
    @Param() param: UpdateEmployeeRequestParam,
  ...
  @ApiResponse({
    status: HttpStatus.OK,
    description: ResponseDescription.OK,
    type: FindEmployeeByIdResponseDto,
  })
  @ApiBadRequestResponse({ description: ResponseDescription.BAD_REQUEST })
  @ApiUnauthorizedResponse({ description: ResponseDescription.UNAUTHORIZED })
  @ApiNotFoundResponse({ description: ResponseDescription.NOT_FOUND })
  ...
  async getEmployeeById(
    @Param() param: FindEmployeeByIdRequestParam,
    @EstablishmentId() establishmentId: string,
  ): Promise<FindEmployeeByIdResponseDto> {
    const id = param.id;
  ...
  async deleteEmployee(
    @Param() param: DeleteEmployeeRequestDto,
    @EstablishmentId() establishmentId: string,
  ): Promise<void> {
    const id = param.id;
