...
import { FindEmployeeResponseDto } from "../dtos/find-employee-response.dto";
...
import { FindEmployeeByIdResponseDto } from "../dtos/find-employee-by-id-response.dto";
import { FindEmployeeByIdRequestDto } from "../dtos/find-employee-by-id-request-param.dto";
...
export class EmployeeController {
  ...
  @Get()
  @ApiResponse({ status: HttpStatus.OK, description: ResponseDescription.OK, type: FindEmployeeResponseDto })
  ...
  async getEmployee(@EstablishmentId() establishmentId: string): Promise<FindEmployeeResponseDto> {
  ...
  async createEmployee(@Body() body: CreateEmployeeRequestDto, @EstablishmentId() establishmentId: string): Promise<void> {
    ...
    const command = new CreateEmployeeCommand(establishmentId, email, name, password);
  ...
  @Get(":id")
  @ApiResponse({ status: HttpStatus.OK, description: ResponseDescription.OK, type: FindEmployeeByIdResponseDto })
  @ApiBadRequestResponse({ description: ResponseDescription.BAD_REQUEST })
  @ApiUnauthorizedResponse({ description: ResponseDescription.UNAUTHORIZED })
  @ApiNotFoundResponse({ description: ResponseDescription.NOT_FOUND })
  @ApiInternalServerErrorResponse({ description: ResponseDescription.INTERNAL_SERVER_ERROR })
  async getEmployeeById(@Param() param: FindEmployeeByIdRequestDto, @EstablishmentId() establishmentId: string): Promise<FindEmployeeByIdResponseDto> {
    const id = param.id
